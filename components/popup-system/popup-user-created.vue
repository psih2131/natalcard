<template>
    <div class="popup popup-user-created">
        ...
        <p class="popup-user-created__title">Звезды сошлись</p>
        <p class="popup-user-created__subtitle">Теперь вы можете войти в ваш аккаунт</p>

        <div class="popup-user-created__btn-row"> <button class="button-popup" @click="goToLoginAccount()">Войти в акаунт</button></div>
